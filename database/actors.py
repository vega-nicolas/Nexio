...
def addActor(user_id: int, uri: str, preferred_username: str, displayName: str, inbox: str, outbox:str, public_key: str, private_key: str) -> bool:
    sql = "insert into actors (user_id, uri, avatar, preferred_username, display_name, inbox, outbox, public_key, private_key, is_local, created_at) values (%s, %s, 'default.png', %s, %s, %s, %s, %s, %s, 1, now());"
